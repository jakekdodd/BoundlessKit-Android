...
public class ConfettiAnimator extends BaseViewAnimator<ConfettiAnimator> {
    ...
    public static ConfettiAnimator demo(View target) {
        return new ConfettiAnimator().addConfetti(
                50,
                50,
                Arrays.asList(
    ...
    public ConfettiAnimator addConfetti(int width, int height, List<ConfettoDrawable.Shape> shapes, List<Integer> colors) {
