...
public class VibrationAnimator extends BaseViewAnimator<VibrationAnimator> {
    ...
    /**
     * @param translation The number of points to shimmy in a single direction.
     ...
     *
     * @param shimmyVertically If true, translation will occur along the Y-axis. If false, translation will occur along the X-axis.
     * @return The object used for Constructor Chaining
     */
