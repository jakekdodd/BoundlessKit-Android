...
public class RotationAnimator extends BaseViewAnimator<RotationAnimator> {
   ...
   *
   * @param ccw If true, the view rotates counterclockwise. If false, the view rotates
   *     clockwise.
   * @return The object used for Constructor Chaining
   */
  ...
  public RotationAnimator setTarget(View target) {
    ...
    getAnimator().play(ObjectAnimator.ofFloat(target, "rotation", 0, (ccw ? -360 : 360) * count));
    return this;
  }
}
