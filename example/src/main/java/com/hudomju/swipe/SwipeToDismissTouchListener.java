        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss && mDownPosition != ListView.INVALID_POSITION) {
                    ...
                    mRowContainer.undoContainer.animate().translationX(0);
                } else {
                    // cancel
                    mRowContainer.getCurrentSwipingView()
                            .animate()
                            ...
                            .setListener(null);
                    // swipe view
                    mRowContainer.undoContainer.animate()
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    ...
                    // swipe view
                    mRowContainer.undoContainer.setVisibility(View.VISIBLE);
                    mRowContainer.undoContainer.setTranslationX(mViewWidth + deltaX);
                    return true;
                }
                break;
            }
