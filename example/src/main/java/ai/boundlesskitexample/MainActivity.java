package ai.boundlesskitexample;
...
import ai.boundless.reward.ConfettiAnimator;
import ai.boundlesskitexample.db.TaskContract;
import ai.boundlesskitexample.db.TaskDbHelper;
import ai.boundless.BoundlessKit;
import ai.boundless.reward.PulseAnimator;
import ai.boundless.reward.RotationAnimator;
import ai.boundless.reward.ShimmyAnimator;
import ai.boundless.reward.VibrationAnimator;
import ai.boundless.reward.EmojisplosionAnimator;
import ai.boundless.reward.SheenView;
import ai.boundless.reward.candybar.Candybar;
...
//                        return;
    ...
    public void addDemoTasks(){
        BoundlessKit.debugLog("App", "Current user id:" + BoundlessKit.getUserId(getApplicationContext()) + " experimentGroup:" + BoundlessKit.getExperimentGroup(getApplicationContext()));
        BoundlessKit.mapUserId(getApplicationContext(), "externalDev");
