...
public final class CandyBar {
    ...
    /**
     * Make a CandyBar to display an icon and message text
     *
     ...
     *                 #LENGTH_LONG}
     */
    public CandyBar(View view, int candy, String title, String subtitle, int backgroundColor, int duration){
...
//        formattedText.setSpan(new RelativeSizeSpan(1.25f), 0, title.length(), 0);
     ...
     *                 #LENGTH_LONG}
     */
    public CandyBar(View view, int candy, CharSequence text, int backgroundColor, int duration){
    ...
    private static Snackbar makeSnackbarWithIcon(View view, int icon, CharSequence text, int backgroundColor, int duration){
