package boundless.kit.integration;
...
import boundless.kit.data.storage.contracts.ReportedActionContract;
import boundless.kit.data.storage.contracts.SyncOverviewContract;
import boundless.kit.data.storage.contracts.TrackedActionContract;
